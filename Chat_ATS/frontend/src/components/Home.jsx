  ...
  return (
    ...
    >
        ...
        <motion.div className="space-y-2" variants={itemVariants}>
          ...
          >
            Welcome to <motion.span 
              ...
              animate={{
                textShadow: ["0 0 8px rgba(59,130,246,0)", "0 0 8px rgba(59,130,246,0.5)", "0 0 8px rgba(59,130,246,0)"],
              }}
              transition={{
                duration: 3,
                repeat: Infinity,
      ...
      <motion.button
        ...
        whileHover={{
          background: ["linear-gradient(to right, #3B82F6, #2563EB)", "linear-gradient(to right, #2563EB, #1D4ED8)"],
          scale: 1.05,
